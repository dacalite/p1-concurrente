...
```
java -Dspring.profiles.active=production -jar ./build/libs/stark-security-system-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=io.starkindustries/stark-security-system
```
